...
\section*{Glosses}
    ...
    \largerpage[2]
		\begin{tabbing}
			...
			\tsc{tr}	\>	stem augment vowel for \\ \> transitive verbs in certain \\ \> verb forms\\
			\tsc{until}	\>	temporal enclitic\\
			\tsc{up}	\>	spatial meaning `up(wards)'\\
			\tsc{when}	\>	temporal enclitic `when'
		\end{tabbing}
	\end{multicols}
