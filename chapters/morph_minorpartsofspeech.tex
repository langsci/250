...
\begin{itemize}
	...
	\item	pause fillers, address \isi{particles}, exclamatives, \isi{interjections}, and other \isi{particles} (\refsec{sec:Pause fillers, address particles, exclamatives, and interjections})
...
\begin{table}
	...
	\begin{tabularx}{0.98\textwidth}[]{%
		...
		\midrule
			...
			\tit{=q'al}			&	\tsc{mod}	&	modal \isi{particle} (\refsec{ssec:The enclitic =q'al})\\
			\tit{=e\slash =ja}		&	\tsc{q}	&	marker for content \isi{questions} (\refsec{sec:Content questions})\\
			\tit{=w\slash =uw\slash =ew}	&	\tsc{q}	&	marker for polar \isi{questions} (\refsec{sec:Simple polar questions and disjunctive polar questions})\\
...
\begin{exe}
	...
	\ex	\isi{analytic verb forms}	\label{ex:analytic verb forms minor}
	\begin{xlist}
...
\begin{exe}
	...
	\ex	{\isi{analytic verb forms} without a copula}\label{ex:analytic verb forms without a copula minor}
	\begin{xlist}
...
The \isi{enclitic} \tit{=q'ar} is a modal \isi{particle} that partially overlaps in its uses with \tit{=q'al} (\refsec{ssec:The enclitic =q'al}) and \tit{=n(u)} (\refsec{ssec:The enclitic =n(u)}). Like \tit{=q'al} it cannot be used in \isi{questions} together with the interrogative \isi{particles}. However, it does not belong to the class of predicative \isi{particles}. It bears some resemblances to German \tit{doch} and Russian \tit{že}.
...
Common address \isi{particles} are \refex{ex:pause fillers interjections minor}. Some examples are given in \xxref{ex:‎He came, and she said (to him), Hey Iljas. (He said), Hi minor}{ex:‎Ooh, my dear boy, I thought, who are you minor}.
%
\begin{exe}
