...
In grammars of Standard Dargwa, the short adjectives are said to be more archaic and basically only used in poetry and other types of fictional literature as expressive means to describe emotions and feelings \citep[26]{vandenBerg2001}; \citep[207\tnd208]{Abdullaev2014}. According to the latter grammar, adjectives with gender prefixes do not have a short form. This is in plain contrast to Sanzhi Dargwa, where they have a short form, e.g. \tit{ca b-uqen q'aˁli} (one \tsc{n-}long branch) \sqt{one long branch}. Furthermore, in Sanzhi short adjectives are at least as common as adjectives with the attributive suffix, if not more common.
