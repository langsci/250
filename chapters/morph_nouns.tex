...
\begin{enumerate}
	...
	\begin{exe}
		...
		\gll	itːa-j		ʡuˁrus	ʁaj	d-alχ-ul	akːʷ-i=q'al\\
			\textsc{3pl}.\textsc{obl}-\textsc{dat}	Russian	language	\textsc{npl}-know.\textsc{ipfv}-\textsc{icvb}	\textsc{cop.neg}-\textsc{hab}.\textsc{pst}=\textsc{mod}\\
...
The suffix of the \textsc{sub}-series is \textit{-gu}. The spatial meaning of the \textsc{sub}-series is \sqt{under}. It is added to the oblique form of the noun, but for many nouns the oblique form can be identical to the citation form \refex{(She) went to pee under the bushes}-\refex{In ancient times when we were in Sanzhi we baked (bread) in the community oven}. 
%
\begin{exe}
