...
There is another group of four manner adverbs with a similar meaning as the adverbs ending in \tit{-itːe}, namely \tit{itwaj}, \tit{hetwaj}, \tit{hitwaj}, and \tit{ižwaj} \sqt{like that, and so}. Their usage is illustrated in \xxref{ex:They are also like this, like Russians, even now}{ex:Uh, and so he did not marry}.
%
\begin{exe}
