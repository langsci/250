...
\begin{itemize}
	...
	\item	\tit{ce} + \tit{qːel}: the second part is the \isi{temporal enclitic} \tit{=qːel} \sqt{when, while, at that time} (\refsec{sec:\isi{enclitic} =qella})
\end{itemize}
%
