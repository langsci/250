...
Note that the suffix -\textit{ce} also occurs in nominalized relative clauses that semantically resemble complement clauses of the activity type. These constructions are discussed in \refsec{ssec:Nominalized relative clauses used with emotion and cognition predicates}.
