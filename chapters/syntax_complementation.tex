...
The chapter closes with a short discussion of constructions that syntactically do not represent \isi{complementation}, but semantically resemble complement constructions. Parentheticals (\refsec{ssec:Parentheticals}), nominalized \isi{relative clauses} (\refsec{ssec:Nominalized relative clauses resembling complement constructions}), and \isi{adverbial clauses} (\refsec{ssec:Adverbial clauses used with emotion and cognition predicates}) belong to these constructions.
...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item	\isi{quotative} \isi{particles} \tit{bik'ul, haʔible} (\refsec{ssec:The quotative particles})
...
Note that the suffix -\textit{ce} also occurs in nominalized \isi{relative clauses} that semantically resemble complement clauses of the activity type. These constructions are discussed in \refsec{ssec:Nominalized relative clauses resembling complement constructions}.
