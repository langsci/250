...
\begin{table}
	...
	\begin{tabularx}{0.90\textwidth}[]{%
		...
		\midrule
			\multicolumn{2}{l}{\tbf{monovalent predicates}}\\
			~~SV		&	neutral or subject focus or presentational focus\\
			~~VS		&	fully-focused (presentational) or topicalizing of subject\\[2mm]

			\multicolumn{2}{l}{\tbf{bivalent predicates}}\\
			~~SOV	&	neutral or object focus\\
			~~SVO	&	neutral or subject focus or occasionally presentational\\
			{}		&	~~structure with object focus\\
			~~OVS	&	object focus (+ predicate) and / or topicalization of \\
			{}		&	~~subjects / S is a contrastive topic\\
...
\begin{exe}
	...
	\glt	\sqt{Now I will / have to start to make KHINKAL.}
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{It is me who will / have to tell Sanijat the story.}
...
\begin{exe}
	...
	\glt	(Intended meaning: \sqt{WHEN will you / do you have to go to Druzhba?})
\end{exe}
...
It is slightly easier to find examples with interrogative enclitics \refex{ex:I asked Bahama, who is it that is wrapped there}-\refex{ex:‎‎Or is this her who is stealing} or the modal particle \tit{=q'al} \refex{ex:‎‎‎This is my son?!‎ ‎‎Yes, he says}-\refex{ex:‎It was him himself who had agreed to get off (the car) in Kala (place name)}; see also the example \refex{ex:But you were the one who said that they had taken only Alibatir to the ditch@26b} above. All corpus examples discussed so far can be classified as selective focus, because the focus selects one item from among a presupposed set of possible alternative values \citep[62]{Dik.etal1981}.
%
\begin{exe}
