...
The focus-sensitive \is{focus-sensitive particle}particles can be encliticized to focal items in term focus-constructions as was described in \refsec{ssec:Contrastive focus and floating predicative particles} above. Focal items are frequently nominals or adverbials, but verbs can also be \is{focus}focused. If the focal item is a verb, the enclitics are either added to the finite inflected verb or to some other part of the predicate such as the \isi{preverb} \refex{ex:He guarded me well, he also guarded me safely, although without brothers and sisters}, or the verb appears in a non-finite form such as the \isi{infinitive} \refex{ex:‎Coming home is not bad}.
