...
It is possible to use the \isi{constituent focus} construction in \is{interrogative clause}interrogative clauses. In this construction the interrogative \isi{enclitic} is attached to the item in focus and the verb must take the form of a \isi{participle}. See \refsec{ssec:Contrastive focus and floating predicative particles} below for more details and examples.
