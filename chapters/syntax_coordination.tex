...
This chapter describes the coordination of phrases (\refsec{sec:Coordination of noun phrases and other phrases}) and clauses (\refsec{ssec:Conjunctive coordination of clauses}), including adversative (\refsec{ssec:Adversative coordination of clauses}) and disjunctive coordination (\refsec{ssec:Disjunctive coordination of clauses}).
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Coordination of noun phrases and other phrases}
\label{sec:Coordination of noun phrases and other phrases}

For the coordination of noun phrases the additive enclitic \tit{=ra} is used (\refsec{ssec:The additive enclitic}). It is encliticized to the head of every member of the conjunction, which can consist of more than two noun phrases \refex{ex:‎‎‎To Kajakent, from here up downwards we travelled, Abdukhalik, Isakadi and me, for our matters}.
%
\begin{exe}
...
The enclitic can also coordinate other types of phrases or modifiers within a noun phrase. In \refex{ex:‎‎‎as much as being embarrassed and anxious in front of people} two adverbials are conjoined, in \refex{ex:‎Now I forget what I say and what I do} two participles and in \refex{ex:‎Such a story happened to Tawlu and him} two extraposed genitives:
%
\begin{exe}
...
The additive enclitic is used in comitative constructions formed with reflexive pronouns (\refsec{sec:Comitative constructions}). Syntactically, they have the structure of coordinated noun phrases (NP\tit{=ra} \tsc{refl}\tit{=ra}), e.g. \refex{ex:with his family}.
%
\begin{exe}
...
Occasionally, noun phrase conjunctions or conjunctions of other phrases occur without overt marking by simple juxtaposition of the phrases \refex{ex:There were mother and son}, \refex{ex:‎They were hungry and poor}. With respect to nouns there is only a very limited number of kinship terms such as the ones in the examples \refex{ex:There were mother and son} that allow for coordination by juxtaposition. Sanzhi also has other coordinators that are loans, namely \tit{wa} \sqt{and}, and the Russian conjunctions \tit{i} \sqt{and}, \tit{a} \sqt{and, but}, but these loan words are only used in clause coordination (\refsec{sec:Coordination of clauses other phrases}). That the two nouns in \refex{ex:There were mother and son} are coordinated is not only clear from the meaning of the clause and their juxtaposition, but also from the gender/number agreement on the verb, human plural (\tsc{hpl}), which is used for conjoint noun phrases with human referents.
%
\begin{exe}
...
It is possible to form disjunctive noun phrases, either by means of the disjunction \tit{ja} (or \tit{ja} bearing the additive enclitic) \refex{ex:their pumpkins or watermelons} or by means of the polar question marker \tit{=w} \refex{ex:‎a trolleybus or a bus} that is used in disjunctive polar questions (see \refsec{sec:Simple polar questions and disjunctive polar questions} for details on disjunction encoded by the polar interrogative enclitic and more examples).
%
\begin{exe}
...
Sanzhi Dargwa, like many East Caucasian languages, does not have native words or special syntactic strategies for the coordination of independent main clauses, except for simple juxtaposition. Instead, the main way of combining clauses such that they are semantically equivalent to coordinated clauses in European languages is the use of simple converbs, predominantly of the preterite converb \refex{ex:‎We added milk, prepared flat breads and ate them}. Those clauses sometimes contain the additive enclitic \tit{=ra}, which is used for the coordination of phrases (\refsec{sec:Coordination of noun phrases and other phrases}), on a constituent such as the object or in some other position. Nevertheless with respect to their morphosyntactic properties these constructions do not represent coordination in the strict sense since they contain dependent clauses and they show some other properties of subordination.
%
\begin{exe}
	...
	\gll	[nejg=ra	dabawit	d-arq'-ib-le]	[č'irič'an	b-arq'-ib-le]	č'irič'an,	hel-tːi	d-uk-a-di	nušːa-l\\
		milk(\tsc{npl})\tsc{=add} add	\tsc{npl-}do\tsc{.pfv-pret-cvb}	flat.bread	\tsc{n-}do\tsc{.pfv-pret-cvb}	flat.bread	that\tsc{-pl}	\tsc{npl-}eat\tsc{.ipfv-hab.pst-1}	\tsc{1pl-erg}\\
	\glt	\sqt{‎We added milk, prepared flat breads and ate them.}
\end{exe}

Juxtaposition of clauses is illustrated in \refex{ex:We fed 28 animals, and we also fed two good (lit. big) breeding bulls.}, \refex{ex:‎They bought (the medicine) at home and I did (the cure)}. Again in the second sentence in \refex{ex:We fed 28 animals, and we also fed two good (lit. big) breeding bulls.} we find the additive \tit{=ra} encliticized to the object, which emphasizes the semantic relationship between the two sentences, but does not function as a syntactic means of clause conjunction. The sentence in \refex{ex:‎They bought (the medicine) at home and I did (the cure)} shows that simple juxtaposition is also possible.
%
\begin{exe}
...
Sanzhi has a set of conjunctions ultimately borrowed from Arabic and Persian of which \tit{wa} \sqt{and}, \tit{amma(ki)} \sqt{but}, and \tit{ja(ra)} \sqt{or} are used for the coordination of main clauses (for a full list see \refsec{sec:Conjunctions}). Moreover, it has borrowed the same conjunctions again from Russian: \tit{i} \sqt{and}, \tit{a} \sqt{and, but}, \tit{no} \sqt{but}, and \tit{ili} \sqt{or}. The Russian conjunctions are far more frequently used than the older borrowings. In particular \textit{wa} is almost absent from the corpus (see below for the number of occurrences).
...
The Russian conjunction \tit{i} is far more frequently used than \tit{wa}, predominantly in translations from Russian \refex{ex:‎‎‎Once a boy found a frog and brought it home}, but also occasionally in natural discourse \refex{ex:‎I am doing my house work and get a pension.}. In addition, it occurs as clause-initial conjunctional adverb \sqt{and then} \refex{ex:‎And they stir him up or they calm him down} that connects longer stretches of discourse (see \refsec{sec:Conjunctions} for examples). The total number of occurrences of \tit{i} in the Sanzhi corpus is 45, whereas  \tit{wa} appears only three times in one and the same text, which had been translated from Russian into Sanzhi and intended to represent a non-colloquial, written text.
%
\begin{exe}
	...
	\gll	[di-la	xazajstweni	ʡaˁči	d-irq'-ul=da]	i	[pensija	ha-jsː-ul=da]\\
		\tsc{1sg-gen}	household	work(\tsc{npl})	\tsc{npl-}do\tsc{.ipfv-icvb=1}	and	pension	\tsc{up}-take\tsc{-icvb=1}\\
	\glt	\sqt{‎I am doing my house work and getting a pension.}
\end{exe}
...
The Arabic conjunction \tit{amma(ki)} \sqt{but} is very rarely employed as a genuine conjunction for independent clauses \refex{ex:‎‎‎He thought that the Kumyk man would come out (of the pit), but a fox came out}, \refex{ex:‎‎‎There is this medical cow-parsnip, but if these (plants) get on (the skin), it is bad}. In the majority of instances it appears as an adversative adverbial in clause-initial \refex{ex:‎But for 600, for 600, that is not bad at all minor} or clause-final position \refex{ex:‎But isn't this similar to a prison minor} (for both examples see \refsec{sec:Conjunctions}). Though in this function it also has the adversative semantics, it rather connects larger episodes of texts that are contrasted to each other.
%
\begin{exe}
	...
	\gll	[birikːʷa=ra	darman-na	d-irχʷ-ar]	amma	[itːi	či-d-ig-ar	wahi-te	ca-d]\\
		cow-parsnip\tsc{=add}	medicine\tsc{-gen}	\tsc{npl-}become\tsc{.ipfv-prs.3}	but	\tsc{3pl}	\tsc{spr-npl-}be\tsc{.pfv-cond.3}	evil\tsc{-dd.pl} \tsc{cop-npl}\\
	\glt	\sqt{‎‎‎There is this medical cow-parsnip, but if these (plants) get on (the skin), it is bad.}
\end{exe}

The same functional range is found with the Russian conjunction \tit{a} \sqt{and, but}. It predominantly occurs as sentence-initial marker of topic switch (\refsec{sec:Conjunctions}), but there are also examples of adversative coordination of clauses \refex{ex:‎There all the people who came want to leave, but there are no cars to leave}. The second adversative coordination from Russian, \tit{no} \sqt{but}, differs in its semantics from \tit{a} because its meaning is more specific. In the Sanzhi corpus there is only one instance of \tit{no} occurring between an independent clause and an ellipsis \refex{ex:‎‎‎The Latvian people were harmful, they were bad people, but order, cleanness is great among them}.
%
\begin{exe}
	...
	\glt	\sqt{‎‎‎The Latvian people were harmful, they were bad people, but order, cleanness (was) great among them.}
\end{exe}
...
For the disjunctive coordination of affirmative clauses the Russian disjunction \tit{ili} is used, which occurs between the members of the disjunction or in clause-initial position \refex{ex:‎Or it must probably be this, or when he is set free, or when is taken (into prison)}.
%
\begin{exe}
