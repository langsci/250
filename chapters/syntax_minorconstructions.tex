...
If the respective item is not permanently possessed but only temporarily in the custody of the possessor, the \tsc{in}-essive case is used \refex{ex:‎‎He has a bottle with a drink} (\refsec{sssec:in-lative -cːe, in-essive -cːe-b, and in-\isi{ablative} -cːe-r}).
%
\begin{exe}
