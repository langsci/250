...
In comparative constructions two or more items are examined in order to note similarities and differences in degree between them \citep[787]{Dixon2008}. Inequality between two items is expressed by means of one of the spatial cases (\refsec{sssec:spr-lative -le/-ja/-a, spr-essive -le-b/-ja-b/-a-b and spr-ablative -le-r/-ja-r/-a-r}). In superlative constructions, degree adverbs occur. Equative constructions and the expression of similarity are realized by means of several particles (\refsec{sec:Equative constructions and the expression of similarity}).
...
\begin{exe}
	...
	\gll	[hin-na	badra=ra	ca-w=ra]	heχ	ka-jcː-ur	ca-w\\
		{\db}water\tsc{-gen}	bucket\tsc{=add}	\tsc{refl-m=add}	\tsc{dem.down}	\tsc{down}-stand\tsc{.m.pfv-pret}	\tsc{cop-m}\\
