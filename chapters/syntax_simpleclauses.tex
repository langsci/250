...
Extended \isi{transitive verbs} (\refsec{sec:Extended transitive verbs and ditransitive verbs}) add a further G argument marked by the \isi{dative} or by \isi{spatial cases} to the \isi{ergative} A and the \isi{absolutive} T \refex{ex:The fox gave him his hair}.
%
\begin{exe}
