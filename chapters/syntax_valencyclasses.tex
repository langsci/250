...
\begin{table}
	...
	\begin{tabularx}{0.98\textwidth}[]{%
		...
		\multicolumn{3}{c}{\tbf{\tsc{monovalent predicates}}}\\
			...
			S-\tsc{abs}
		&	1
		&	\tit{b-ubk'- / b-ebk'-} \sqt{die}; \tit{či-r-ha-b-ulq- / či-r-ha-b-uq-} \sqt{vomit} \refex{ex:My arms got tired}, \refex{ex:If it was (the time) to die, I would have died long ago}\\[2mm]

 			\multicolumn{3}{l}{\tbf{monovalent affective verbs (dative)}}\\
			S-\tsc{dat}
		&	1
		&	\tit{ʡaˁħ-le ca-b} \sqt{feel good, be well}; \tit{c'aχ ka-b-ircː- / c'aχ ka-b-icː-} \sqt{feel ashamed} \refex{ex:I feel bad there},  \refex{ex:At night I had no sleep}\\[2mm]
				   	\midrule
				   	\multicolumn{3}{c}{\tbf{\tsc{bivalent predicates}}}\\
			\multicolumn{3}{l}{\tbf{extended intransitive (absolutive + dative / spatial case)}}\\	   
			S-\tsc{abs}, P-\tsc{dat}
		&	2
		&	\tit{kːač b-irk-} / \tit{kːač b-ik-} \sqt{touch}, \tit{gu-lik'-} \sqt{listen to} \refex{ex:I am listening to her/his song}\\	   
		...
		&	2
		&	\tit{uruχ b-irχʷ- / uruχ b-iχʷ-} \sqt{become/be afraid of}; \tit{uruc b-irχʷ- / uruc b-iχʷ-} \sqt{be/become ashamed / embarrassed of} \refex{ex:Are you afraid of your wife? he says.}\\[2mm]
   
			\multicolumn{3}{l}{\tbf{bivalent affective verbs (dative + absolutive / other)}}\\
			A-\tsc{dat/erg}, P-\tsc{abs}
		&	2
		&	\tit{či-b-ig- / či-b-ag-} \sqt{see}; \tit{b-irʁ- / b-arʁ-} \sqt{understand} \refex{ex:You (pl.) bored me, I said},  \refex{ex:I know a good place}\\
			A-\tsc{dat}, \hspace*{0.5em}P-\tsc{ante-ablative}
		&	2
		&	\tit{c'aχ-le ca-b} \sqt{to feel/be ashamed in front of}; \tit{b-irt'- / b-et'-} \sqt{long for, miss} \refex{ex:Hey, Kurban, I am ashamed in front of you}\\[2mm]

			\multicolumn{3}{l}{\tbf{transitive (ergative + absolutive)}}\\
			A-\tsc{erg}, P-\tsc{abs}
		&	2
		&	\tit{b-irc- / b-ic-} \sqt{sell}; \tit{b-urχ- / b-arχ-} \sqt{sew} \refex{ex:Did these people beat you up},  \refex{ex:The boy stopped him}\\[2mm]

			\multicolumn{3}{l}{\tbf{other bivalent verbs (ergative + dative)}}\\
			A-\tsc{erg}, P-\tsc{dat}
		&	2
		&	\tit{b-aˁq- / b-uˁrq-} \sqt{hit}; \tit{zaˁnʁ d-aˁq- / zaˁnʁ d-uˁrq-} \sqt{phone} \refex{ex:Brother called you}\\[2mm]
	\midrule
	\multicolumn{3}{c}{\tbf{\tsc{trivalent predicates}}}\\
		...
		&	3
		&	\tit{lukː- / b-ikː-} \sqt{give}; \tit{či-b-iž-aq- / či-b-až-aq-} \sqt{show}; \tit{haʔ- / herʔ-} \sqt{say, tell}; \tit{b-urs-} \sqt{say, tell}; \tit{xar b-irʁ- / xar b-eʁ-} \refex{ex:The snake gave it to me}, \refex{ex:He hit with the fist on the jaw of his wife}, \refex{ex:Why did he not tell us that the water does not flow, they said}\\ 
		\lspbottomrule
	\end{tabularx}
\end{table}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{ʡaˁlħ-} / \tit{ʡaˁħ-} \sqt{fly}
		\ex	\tit{b-ubk'-} / \tit{b-ebk'-} \sqt{die}
		\ex	\tit{b-ilš-} / \tit{b-iš-} \sqt{die out, extinguish}
		\ex	\tit{ka-b-ilsː-} / \tit{ka-b-isː-} \sqt{lie down, sleep}
		\ex	\tit{ʡiˁbħ-} / \tit{ʡaˁbħ-} \sqt{get tired}
		\ex	\tit{rurt-} / \tit{b-ert-} \sqt{curdle, solidify}
		\ex	\tit{či-r-ha-b-ulq-} / \tit{či-r-ha-b-uq-} \sqt{vomit} 
		\ex	\tit{luqː- / b-elqː-} \sqt{be, become full, fed up}
		\ex	\tit{t'aš b-ircː- / t'aš b-icː-} \sqt{stop}
		\ex	\tit{uruc b-ik'ʷ-; uruc b-irχʷ- / uruc b-iχʷ-} \sqt{be/become embarrassed, ashamed}	
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{dum b-urc- / dum b-uc-} \sqt{fast}
		\ex	\tit{čːal b-ik'ʷ-; čːal b-ulq- / čːal b-uq-} \sqt{argue, quarrel}
		\ex	\tit{sːiħ b-ik'ʷ-} \sqt{breath}
		\ex \textit{qal-la b-iχʷ-ij / qal-la ka-b-iž-ij} \sqt{get married} 
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex	\tit{buruš hitːi sa-b-irk- / buruš hitːi sa-b-ik-} \sqt{sleep, fall asleep}	
		\ex	\tit{beža hitːi d-irk- / beža hitːi d-ik-} \sqt{catch a cold}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex	\tit{uruχ b-irχʷ- / uruχ b-iχʷ-} \sqt{be/become afraid of, fear}
		\ex	\tit{uruc ca-b, uruc b-ik'ʷ-} \sqt{be ashamed of, be embarrassed of}
		\ex	\tit{uruc b-irχʷ- / uruc b-iχʷ-} \sqt{be/become ashamed of, be/become embarrassed of}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{b-isː- / b-asː-} \sqt{take, buy}
		\ex	\tit{b-irq'- / b-arq'-} \sqt{do, make}
		\ex	\tit{b-irc- / b-ic-} \sqt{sell}
		\ex	\tit{b-urχ- / b-arχ-}	\sqt{sew}
		\ex	\tit{b-alš- / b-aš-} \sqt{knead}
		\ex	\tit{b-it-} \sqt{beat up}
		\ex	\tit{ač b-irq'- / ač b-arq'-} \sqt{open}
		\ex	\tit{qaˁš k-aʁ-} \sqt{cut into pieces}
		\ex	\tit{aq (či-ha-)b-irq'- / aq (či-ha-)b-arq'-} \sqt{lift up, take up}	
		\ex	\tit{t'aš b-ircː-aq- / t'aš b-icː-aq-; t'aš-aʁ-} \sqt{stop}
		\ex	\tit{bursːi b-arq'- / bursːi b-irq'-} \sqt{teach}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{lukː- / b-ikː-} \sqt{give}
		\ex	\tit{qar b-irq'- / qar b-arq'-} \sqt{charge, entrust with}
		\ex	\tit{xadi lukː- / xadi b-ikː-} \sqt{marry off}
		\ex	\tit{či-b-iž-aq- / či-b-až-aq-} \sqt{show}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{b-uˁrq- / b-aˁq-} \sqt{beat, hit}
		\ex	\tit{b-urh- / b-erh-} \sqt{knock, strike, bang}
		\ex	\tit{irx- / ixʷ-} \sqt{throw at, shoot}
	\end{xlist}
...
\begin{exe}
	...
	\glt	\sqt{‎‎‎Ali knocked / beat off the giant with the hand.} (E)
\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{ha-ʔ- / h-erʔ-} \sqt{say, tell}
		\ex	\tit{b-urs- / b-ux-} \sqt{say, tell}		
		\ex	\tit{xar b-irʁ- / xar b-eʁ-} \sqt{ask}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex	\tit{sa-b-ik- / s-ak-, h-ak-, k-ak-}  \sqt{bring, lead}
		\ex	\tit{b-uk- / b-erč-} \sqt{take, collect, bring}
		\ex	\tit{(či-)(ka-)b-irxː- / (či-)(ka-)b-ixː-} \sqt{put}
	\end{xlist}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{zaˁnʁ d-uˁrq- / zaˁnʁ d-aˁq-; telepun d-aˁq- / telepun d-uˁrq-} \sqt{call on the phone}
		\ex	\tit{kumek b-irq'- / kumek b-arq'-} \sqt{help} 	
		\ex	\tit{tamaša b-arq'- /  tamaša b-irq'-} \sqt{wonder}
		\ex	\tit{urk'ec'i b-irq'- / urk'ec'i b-arq'-; urk'ec'i či-d-uq- / urk'ec'i či-d-ulq-} \sqt{pity, feel sorry for}
		\ex	\tit{ʁaj b-irq'- / ʁaj b-arq'-} \sqt{talk, tell, speak}
		\ex	\tit{tiladi b-irq'- / tiladi b-arq'-} \sqt{beg, request}
		\ex	\tit{anru lukː- / anru b-ikː-} \sqt{command}
		\ex	\tit{ʁaj lukː- / ʁaj b-ikː-} \sqt{promise}
		\ex	\tit{qaˁb (sa)-b-urc- / qaˁb (sa)-b-urc-} \sqt{embrace, hug}
	\end{xlist}
...
Bivalent affective verbs are a relatively small class of two-place verbs with epxeriential / affective semantics \refex{ex:bivalent affective verbs}. They express unintentional and uncontrollable perception, emotion, volition, cognitive activities and other non-agentive events and situations. 

%
\begin{exe}
	\ex	\label{ex:bivalent affective verbs}
	\begin{xlist}
		\ex	\tit{či-b-ig- / či-b-ag-} \sqt{see}
		\ex	\tit{t'am b-iq'- / t'am b-aq'-} \sqt{hear}
		\ex	\tit{b-ikː-} \sqt{want, like, love}
		\ex	\tit{b-irʁ- / b-arʁ-} \sqt{understand}
		\ex	\tit{qum urt- / qum ert-} \sqt{forget}
		\ex	\tit{b-alχ- / b-aχ-} \sqt{know}
		\ex	\tit{b-urkː- / b-arkː-} \sqt{find}
		\ex	\tit{han b-irk- / han b-irk-} \sqt{remember, seem}
		\ex	\tit{b-ičː-aq-} \sqt{like, love}
		\ex	\tit{či-b-b-irt'- / či-b-b-et'-} \sqt{be bored}
		\ex	\tit{b-irt'- / b-et'-} \sqt{be bored}
	\end{xlist}
\end{exe}
...
\begin{xlist}
		\ex \tit{ d-uq- / simi d-ulq-} \sqt{be angry}
		\ex \tit{urk'ec'i d-uq- / urk'ec'i d-ulq-} \sqt{pity}
\end{xlist}
...
\ex \label{embarrassed constructions}
	\begin{xlist}
		\ex	\tit{c'aχ ka-b-ircː- / c'aχ ka-b-icː; c'aχ-le ca-b} \sqt{feel ashamed, be/become embarrassed} 
		\ex	\tit{c'aχ-le ca-b} \sqt{be ashamed by }
		\ex	\tit{b-irt'- / b-et'-} \sqt{long for}
	\end{xlist}
	\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex	\tit{b-elq'-} (\tsc{pfv}) / \tit{luq'-} (\tsc{ipfv}) \sqt{break, shatter, smash}
		\ex	\tit{b-erc'-} (\tsc{pfv}) / \tit{b-uc'-} (\tsc{ipfv}) \sqt{fry, roast, bake}
		\ex	\tit{b-ic'-} (\tsc{pfv}) / \tit{b-irc'-} (\tsc{ipfv}) \sqt{fill}
		\ex	\tit{b-aˁč} (\tsc{pfv}) / \tit{b-aˁlč} (\tsc{ipfv}) \sqt{squeeze, break, crush, crack, trample}
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{b-elč'-} (\tsc{pfv}) / \tit{b-uč'-} (\tsc{ipfv}) \sqt{read, learn, study, sing}, \refex{ex:labile intransitive}, \refex{ex:labile transitive}
		\ex	\tit{b-erkʷ-} (\tsc{pfv}) / \tit{b-uk-} (\tsc{ipfv}) \sqt{eat}
		\ex	\tit{b-erčː-} (\tsc{pfv}) / \tit{b-učː-} (\tsc{ipfv}) \sqt{drink, smoke, consume}
		\ex	\tit{b-arq'-} (\tsc{pfv}) / \tit{b-irq'-} (\tsc{ipfv}) \sqt{do, make, be busy}
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\glt	\sqt{‎He is reading / studying.} (E)

		\ex	\label{ex:study read intransitive}
		\gll	uč'-en	/	ma-wč'-ut!\\
			learn\tsc{.m.ipfv-imp}	/	\tsc{proh-}learn\tsc{.m.ipfv-proh.sg}\\
		\glt	\sqt{Study!} OR \sqt{Read!} / \sqt{Do not study!} OR \sqt{Do not read!} (E)
	\end{xlist}
	...
	\begin{xlist}
		...
		\glt	\sqt{Read the book! / Do not read the book!} (E)
	\end{xlist}
\end{exe}
...
The major problem in the analysis of antipassive constructions concerns the closeness to S=A labile verbs that can be used intransitively and transitively, thereby preserving the agent argument (\refsec{sec:Labile verbs}). For instance, the imperfective stem of the verb \tit{b-elč'-} (\tsc{pfv}) / \tit{b-uč'-} (\tsc{ipfv}) \sqt{read, learn, study, sing} can be used in an intransitive construction. When adding the ergative adjunct \tit{student-li} (student\tsc{-erg}) to \refex{ex:She reads / studies} the translation is unambiguously \sqt{she studies (at a university as a student)}. The same verb can be used in a transitive construction with an ergative agent and an absolutive patient \refex{ex:S/he reads (i.e. sings) nasheeds@varA}.
%
\begin{exe}
	\ex	\label{ex:She reads / studies}
	\gll	it	r-uč'-unne	ca-r\\
		\tsc{dem}	\tsc{f-}read\tsc{.ipfv-icvb}	\tsc{cop-f}\\
	\glt	\sqt{She reads / studies.} (E)
