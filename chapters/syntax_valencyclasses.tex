...
\begin{table}
	...
	\begin{tabularx}{0.98\textwidth}[]{%
		...
		\multicolumn{3}{c}{{\tsc{monovalent predicates}}}\\\midrule
			...
			S-\tsc{abs}
		&	1
		&	\tit{b-ubk'-\slash b-ebk'-} \sqt{die}; \tit{či-r-ha-b-ulq-\slash či-r-ha-b-uq-} \sqt{vomit} \refex{ex:My arms got tired}, \refex{ex:If it was (the time) to die, I would have died long ago}\\\tablevspace
