...
This includes \is{transitive verb}transitive verbs of which the \isi{agent} is then often omitted because the focus is on the resulting state \refex{ex:Her head has been wounded}.
%
\begin{exe}
