...
\begin{enumerate}
	...
	\begin{exe}
		...
		\gll	šːi-l-cːe-w	er	Ø-ik'-ul	ca-w,	ča-k'al	caʔarrah	admi	w-akːu\\
			village\tsc{-obl-in-m}	look	\tsc{m-}look.at\tsc{.ipfv-icvb}	be\tsc{-m}	who\tsc{-indef}	not.one	person	\tsc{m-cop}\tsc{.neg}\\
...
\begin{exe}
	...
	\gll	du-l t'ult' b-uk-an	ca-b	/	akː-u\\
		\tsc{1sg-erg}	bread	\tsc{n-}eat\tsc{.ipfv-ptcp}	be\tsc{-n} /	\tsc{cop.neg-prs}\\
...
\begin{exe}
	...
	\gll	Sanijat-li 	t'alaˁħ-ne	d-irc-ib ca-d.	dam=q'ar	il	či-b-až-ib=da\\
		Sanijat\tsc{-erg}	dishes\tsc{-pl}	\tsc{npl-}wash\tsc{.pfv-pret} \tsc{cop-npl}	\tsc{1sg.dat=prt}	\tsc{3sg}	\tsc{spr-n-}see\tsc{.pfv-pret=1}\\
...
\begin{exe}
	...
	\gll	qili-w	ča-k'al	w-aːkːu,	aba	r-ebč'-ib-le	ca-r\\
		home\tsc{-m}	who\tsc{-indef}	\tsc{m-}be\tsc{.neg}	mother	\tsc{f-}die\tsc{.pfv-pret-cvb}	\tsc{cop-f}\\
...
\begin{exe}
	...
	\gll	b-ik'-ul	ca-b	``uškul-le	w-aš-ib-il		akːʷ-adi	du''\\
		\tsc{n-}say\tsc{.ipfv-icvb}	\tsc{cop-n}	school\tsc{-loc}	\tsc{m-}go\tsc{-pret-ref}	be\tsc{.neg-hab.pst.1}	\tsc{1sg}\\
