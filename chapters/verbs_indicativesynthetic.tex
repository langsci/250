...
\begin{enumerate}
	...
	\begin{exe}
		...
		\glt	\sqt{Should / will I sing my sad song or not?} (a more literal translation is: \sqt{To sing or not to sing the song about my sufferings?})
	\end{exe}
\end{enumerate}
...
\begin{exe}
	...
	\glt	\sqt{I don't know anything.} (NOT: \sqt{I will / should not know anything.})

	\ex	\label{ex:Madina loves me}
	\gll	Madina-j	du	w-ičː-aq-id\\
		Madina\tsc{-dat}	\tsc{1sg}	\tsc{m-}want\tsc{.ipfv-caus-1.prs}\\
	\glt	\sqt{Madina loves me (masc.).} (NOT: \sqt{Madina will / should love me.}) (E)
\end{exe}
