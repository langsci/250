...
\begin{table}
	...
	\begin{tabularx}{0.78\textwidth}[]{%
		...
		\midrule
			\multicolumn{4}{l}{{\tit{VC(ː)} vs. \tit{VrC(ː)} (\isi{gender} \is{agreement prefix}agreement prefixes only with}}\\
...
\midrule
			...
			\multicolumn{4}{l}{{\tit{luC} vs. \tit{alC/elC/iC} (\isi{gender} \is{agreement prefix}agreement prefixes only with}}\\
			\multicolumn{4}{l}{{\hspace*{1em}perfective stems)}}\\	
			\midrule
...
To younger speakers of Sanzhi, the specific meanings of the \is{preverb}preverbs \tit{ha-} and \tit{ka-} are not fully clear anymore, and they usually employ only \tit{sa-} as the default form. Older speakers differentiate between:
%
\begin{itemize}
