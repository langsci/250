...
With labile verbs the use of \tit{-e} and \tit{-a} in the imperative singular is possible, where \tit{-e} indicates that the verb is used intransitively and \tit{-a} that it is used transitively \refexrange{ex:Move the chair}{ex:Move (yourself)}.
