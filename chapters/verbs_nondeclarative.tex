...
The \isi{imperative} can be used in combination with the \isi{antipassive} construction, in which case the verb is intransitive and takes the suffix \tit{-e} if the addressee is singular: 
%
\begin{exe}
...
As with the \isi{imperative}, the \isi{prohibitive} is only used with second persons. The second person pronoun functioning as the addressee is mostly omitted, but it can be overtly expressed. Examples \refex{ex:No way you look at them} and \refex{ex:Do not cry, do not wrestle} show \isi{intransitive verbs}. Sentences \refex{ex:Do not raise your hand against your wife}, \refex{ex:Do not hit with a stick} illustrate \isi{transitive verbs}. In addition, \isi{affective verbs} with \isi{dative} addressees (experiencers) are allowed \refex{ex:Do not know this}.
%
\begin{exe}
...
The functions of the \isi{optative} cover:
%
\begin{enumerate}
