...
\subsubsection{The cross-categorical suffixes \tit{-il} and \tit{-ce} / \tit{-te} in combination with the participles}
...
\begin{enumerate}
	...
	\item[(iii)]	subordinating enclitics for the formation of adverbial clauses, e.g. \tit{=sat} / \tit{=satːin} / \tit{= satːinna} \sqt{until}, \tit{=sar} \sqt{before, until} and \tit{bahandan} \sqt{because of} (\refsec{cpt:specializedconverbssubordinatingenclitics})
...
\begin{table}
	...
	\begin{tabularx}{0.40\textwidth}[]{%
		...
		\midrule
			1	&	\tmd		&	\tmd\\
			2	&	\multicolumn{2}{c}{\tit{-itːaj / -utːaj}}\\
			3	&	\multicolumn{2}{c}{\tit{-araj / -anaj}}\\
		\lspbottomrule
	\end{tabularx}
\end{table}
...
\begin{exe}
	...
	\begin{xlist}
		...
		\ex	\tit{bahanne / bahandan} \sqt{because of}	\tab	(causality)	
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{‎When / after / because in that night there was no Icarus coach, he went to Rostov or somewhere else the next day, he went there.}
...
\begin{exe}
	...
	\glt	\sqt{‎I was a milkmaid until / before I got married.}
	...
	\glt	\sqt{``‎‎‎Stand there before / lest / otherwise I hit you with the crook on the head!'' I said.}
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{‎‎‎If / because she comes, I will not go there.} (E)
	...
	\glt	\sqt{Why should I go to Makhachkala, if / since I can will see the concert in Druzhba?} (E)
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{‎While until / as long as he is not drinking, everything is good for them.}
	...
	\glt	\sqt{While / as long as he was looking at its beauty, all animals had already left.}
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{When / as soon as the master saw the stone, he trembled (started to tremble).}
	...
	\glt	\sqt{When / as soon as he went out from there, he mounted the horse, [singing a song he pretended to be drunk] and left.}
	...
	\glt	\sqt{‎As soon as Aminat makes bread / finishes making bread, bring us two (loaves of bread)!} (E)
\end{exe}
...
\begin{table}
	...
	\begin{tabularx}{0.40\textwidth}[]{%
		...
		\midrule
			...
			2	&	\tit{-tːel}	&	\tit{-tːal}\\
			3	&	\multicolumn{2}{c}{\tit{-ar-del / -an-del}}\\
		\lspbottomrule
	\end{tabularx}
\end{table}
...
\begin{table}
	...
	\begin{tabularx}{0.40\textwidth}[]{%
		...
		\midrule
			...
			3	&	\multicolumn{2}{c}{\tit{-aχː-a-n(ne) / -aχː-a-r(re)}}\\
		\lspbottomrule
	\end{tabularx}
\end{table}
%
...
\begin{exe}
	...
	\glt	\sqt{‎if I see the horse (regularly / once)} (E)
\end{exe}
