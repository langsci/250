...
\begin{table}
	...
	\begin{tabularx}{0.9\textwidth}[]{%
		...
		\midrule
			...
			\tit{pikri} \sqt{thought}			&	\tit{b-uq-}~~(\tsc{hpl-}go\tsc{.pfv-}) / 	&	\sqt{think}\\
			{}						&	\tit{b-ik'ʷ-}~~(\tsc{hpl-}say\tsc{.ipfv-}) 	&	{}\\
			\tit{čːal} \sqt{argument, quarrel} 	&	\tit{b-uq-}~~(\tsc{hpl-}go\tsc{.pfv-}) / 	&	\sqt{argue, quarrel}\\
			{}						&	\tit{b-ik'ʷ-}~~(\tsc{hpl-}say\tsc{.ipfv-}) 	&	{}\\
...
\begin{exe}
	...
	\begin{xlist}
		\ex \label{ex:markednouncpgenitiveget married} \textit{qal-la b-iχʷ-ij / qal-la ka-b-iž-ij} (house-\tsc{gen} \tsc{hpl}-be.\tsc{pfv-inf} / house-\tsc{gen} \tsc{down-hpl}-be.\tsc{pfv-inf}) \sqt{get married} 
	...
	\ex	\tit{qaˁb-la b-arq'-ij / qaˁb-la + b-aˁq-ij} (neck-\tsc{gen} \tsc{hpl-}do\tsc{.pfv-inf} / neck-\tsc{gen} \tsc{hpl-}strike\tsc{.pfv-inf}) \sqt{behead}
	\ex	\tit{qal-la r-arq'-ij / qal-la ka-r-at-ij} (house-\tsc{gen} \tsc{f-}do\tsc{.pfv-inf} / house-\tsc{gen} \tsc{down-f-}let\tsc{.pfv-inf}) \sqt{marry off}
...
\begin{table}
	...
	\begin{tabularx}{1.0\textwidth}[]{%
		...
		\midrule
			...
			\tit{č'uˁp} 					&	\tit{b-ik'ʷ-}~~(\tsc{n-}say\tsc{.ipfv-}) /	&	\sqt{suck} (intr.) / (tr.)\\
...
For instance, the bound stem \tit{taˁħ} occurs together with verbs of movement or posture to yield the meaning \sqt{jump}, but it also combines with other verbs. The resulting compounds always denote movement away from a source \refex{ex:One (boar) jumped (down)}-\refex{ex:when (they) cut off the wood}.
%
\begin{exe}
...
\begin{table}
	...
	\begin{tabularx}{0.95\textwidth}[]{%
		...
		\midrule
			...
			\tit{b-iχči(t)} / 	&	\tit{ag-}~~(go\tsc{.pfv-})				&	\sqt{believe}	\\
			~~\tit{b-iχ-b-it-} 	&	{}								&	{}\\
...
\begin{exe}
	\ex	\label{ex:hajbars}
	\begin{xlist}
		\ex	\tit{haj}  \tit{b-iχʷ-} / \tit{haj} \tit{b-arq'-}  \sqt{move, drive}
		\ex	\tit{b-ars} \tit{b-iχʷ-} / \tit{b-ars} \tit{b-arq'-} \sqt{change}
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\begin{xlist}
		\ex	\tit{can} \tit{b-ik-} / \tit{can} \tit{b-arq'-} \sqt{mix, unite, meet}
		\ex	\tit{suk} \tit{b-ik-} / \tit{suk} \tit{b-arq'-} \sqt{meet, gather}
		\ex	\tit{šak} \tit{b-ik-} / \tit{šak} \tit{b-arq'-} \sqt{guess, suspect, feel}
	\end{xlist}
\end{exe}
...
\begin{exe}
	...
	\glt	\sqt{He will / should go to sleep.}
\end{exe}
