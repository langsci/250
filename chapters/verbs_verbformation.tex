...
There are some \isi{nouns} that are particularly productive for the formation of compounds verbs and can combine with a variety of \is{light verb}light verbs. One is the noun \tit{ʁaj} \sqt{word, talk, language}, that occurs in the following compounds:
%
\begin{exe}
